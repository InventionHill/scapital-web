        ...
        <div className="bg-white pt-14 md:pt-19 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-[3rem] font-extrabold text-[#111827]  leading-tight">What Our Clients</h2>
                    <h2 className="text-3xl md:text-[3rem] font-extrabold text-teal-700 leading-tight">True Say</h2>
                    <p className="text-gray-500 font-semibold max-w-3xl mx-auto text-lg leading-relaxed mt-3">
                        Strategic capital deployment for the world's most ambitious individuals an enterprises.
                    </p>
                </div>
                        ...
                        {testimonials.map((t, i) => (
                            <div key={i} className="w-full md:w-1/3 flex-shrink-0 px-4">
                                <div className="bg-white p-10 rounded-[1.08rem] border border-teal-700 relative flex flex-col items-center text-center group h-full">
                                    ...
                                    <h3 className="text-2xl font-normal text-[#111827] mb-4">{t.name}</h3>

                                    <p className="text-[#111827] text-base leading-relaxed mb-6 font-medium flex-grow">
                                        “{t.text}”
                                    </p>

                                    <div className="flex gap-1 text-teal-700 mb-4 justify-center">
